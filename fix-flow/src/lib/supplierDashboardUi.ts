...
const copy = {
  en: {
    ...
    finalQuoteHint: "Unchecked quotes show as Negotiable to the homeowner.",
...
export function statusBadgeClass(
  ...
  switch (status) {
    ...
    case "quoted":
      return "bg-primary/10 text-primary ring-primary/20 dark:bg-primary/15 dark:ring-primary/30";
    case "accepted":
      return "bg-[#4CAF50]/10 text-[#4CAF50] ring-[#4CAF50]/20 dark:bg-[#4CAF50]/15 dark:text-[#4CAF50] dark:ring-[#4CAF50]/30";
    case "rejected":
